...
#     standard = standard.create(charset={"a": "A", "b": "B", "c": "C"})
#     requests.post(urls.CREATE_STANDARD, json=standard)
...
#     response = requests.patch(urls.UPDATE_STANDARD, json=updated_standard)
#     assert response.status_code == 422, message(response)
...
#     standard = standard.create(encoded_char_len=1)
#     requests.post(urls.CREATE_STANDARD, json=standard)
...
#     standard = standard.create(encoded_char_sep="/")
#     requests.post(urls.CREATE_STANDARD, json=standard)
